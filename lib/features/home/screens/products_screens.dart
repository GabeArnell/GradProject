...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  void calcStars() async {
    stars =
        await prodServices.getRating(context: context, product: widget.product);
    setState(() {});
  }
  ...
  void loadSellerInfo() async {
    sellerInfo = await prodServices.getSellerInfo(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(context,
                          ...
                          return SellerScreen(
                            email: sellerInfo['email'].toString(),
            ...
            Padding(
              padding: const EdgeInsets.all(10.0),
              child: (sellerInfo['email'] != user.email)
                  ? TextFormField(
                      decoration: InputDecoration(
